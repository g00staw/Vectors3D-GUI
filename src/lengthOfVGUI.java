...
public class lengthOfVGUI extends JFrame{
    ...
    public lengthOfVGUI(){
        ...
        calculateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (givenVectors.size() == 1) {
                    LengthOfVFunc length = new LengthOfVFunc();
                    double legnthOfV = length.LengthOfVector(givenVectors, false);
                    scoreLabel.setText("Długość wektora: "+legnthOfV);
                }
                else {
        ...
        saveLogsButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                if (givenVectors.size() == 1) {
                    LengthOfVFunc length = new LengthOfVFunc();
                    double legnthOfV = length.LengthOfVector(givenVectors, true);
                    scoreLabel.setText("Długość wektora: "+legnthOfV);
                }
                else {
                    JOptionPane.showMessageDialog(null, "Do przeprowadzenia operacji potrzebny jest wektor.", "Błąd", JOptionPane.ERROR_MESSAGE);
